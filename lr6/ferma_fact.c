...
static CYTHON_INLINE int __pyx_f_10ferma_fact_is_perfect_square(PY_LONG_LONG); /*proto*/
...
static const char __pyx_k_r_2S_s_Cq_4q_2Q_Bb_A_AQ_4q_2Rs[] = "\200\001\340\004\007\200r\210\022\2102\210S\220\001\330\010\017\210s\220\"\220C\220q\340\004\010\210\013\2204\220q\230\003\2302\230Q\330\004\005\330\010\024\220B\220b\230\002\230\"\230A\330\010\013\320\013\034\230A\230Q\330\014\020\220\013\2304\230q\240\001\330\014\023\2202\220R\220s\230\"\230B\230a\330\010\r\210Q";
/* #### Code section: decls ### */
...
#define __pyx_n_u_y __pyx_string_tab[17]
#define __pyx_n_u_y_squared __pyx_string_tab[18]
...
static CYTHON_INLINE int __pyx_f_10ferma_fact_is_perfect_square(PY_LONG_LONG __pyx_v_n) {
 ...
 * 
*/
  __pyx_v_root = ((PY_LONG_LONG)sqrt(__pyx_v_n));
...
static PyMethodDef __pyx_mdef_10ferma_fact_1fermat_factorization = {"fermat_factorization", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_10ferma_fact_1fermat_factorization, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_10ferma_fact_1fermat_factorization(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "fermat_factorization", 0) < 0) __PYX_ERR(0, 8, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("fermat_factorization", 1, 1, 1, i); __PYX_ERR(0, 8, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("fermat_factorization", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 8, __pyx_L3_error)
  __pyx_L6_skip:;
...
*/
    ...
    __pyx_t_2 = __Pyx_PyLong_From_PY_LONG_LONG(__Pyx_div_PY_LONG_LONG(__pyx_v_N, 2, 1)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 11, __pyx_L1_error)
    ...
    if (__Pyx_PyTuple_SET_ITEM(__pyx_t_3, 0, __pyx_mstate_global->__pyx_int_2) != (0)) __PYX_ERR(0, 11, __pyx_L1_error);
 ...
 *         y_squared = x * x - N
*/
  __pyx_v_x = (((PY_LONG_LONG)sqrt(__pyx_v_N)) + 1);
 ...
 *             return x - y, x + y
*/
    __pyx_t_1 = __pyx_f_10ferma_fact_is_perfect_square(__pyx_v_y_squared); if (unlikely(__pyx_t_1 == ((int)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L1_error)
    if (__pyx_t_1) {
...
*/
      __Pyx_XDECREF(__pyx_r);
      __pyx_t_3 = __Pyx_PyLong_From_PY_LONG_LONG((__pyx_v_x - __pyx_v_y)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 18, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_2 = __Pyx_PyLong_From_PY_LONG_LONG((__pyx_v_x + __pyx_v_y)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 18, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_4 = PyTuple_New(2); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 18, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_GIVEREF(__pyx_t_3);
      if (__Pyx_PyTuple_SET_ITEM(__pyx_t_4, 0, __pyx_t_3) != (0)) __PYX_ERR(0, 18, __pyx_L1_error);
      __Pyx_GIVEREF(__pyx_t_2);
      if (__Pyx_PyTuple_SET_ITEM(__pyx_t_4, 1, __pyx_t_2) != (0)) __PYX_ERR(0, 18, __pyx_L1_error);
      __pyx_t_3 = 0;
      __pyx_t_2 = 0;
      __pyx_r = __pyx_t_4;
      __pyx_t_4 = 0;
 ...
 *     if N % 2 == 0:
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_10ferma_fact_1fermat_factorization, 0, __pyx_mstate_global->__pyx_n_u_fermat_factorization, NULL, __pyx_mstate_global->__pyx_n_u_ferma_fact, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_fermat_factorization, __pyx_t_2) < 0) __PYX_ERR(0, 8, __pyx_L1_error)
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {1, 0, 0, 4, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 8, 98};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_N, __pyx_mstate->__pyx_n_u_x, __pyx_mstate->__pyx_n_u_y, __pyx_mstate->__pyx_n_u_y_squared};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_ferma_fact_pyx, __pyx_mstate->__pyx_n_u_fermat_factorization, __pyx_k_r_2S_s_Cq_4q_2Q_Bb_A_AQ_4q_2Rs, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
